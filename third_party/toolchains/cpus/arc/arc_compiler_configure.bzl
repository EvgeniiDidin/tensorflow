...
def _tpl(repository_ctx, tpl, substitutions={}, out=None):
  ...
  repository_ctx.template(
      out,
      Label("//third_party/toolchains/cpus/arc:%s.tpl" % tpl),
      substitutions)


def _arc_compiler_configure_impl(repository_ctx):
  ...
  _tpl(repository_ctx, "CROSSTOOL", {
      "%{ARC_COMPILER_PATH}%": str(repository_ctx.path(
...
arc_compiler_configure = repository_rule(
    implementation = _arc_compiler_configure_impl,
    attrs = {
